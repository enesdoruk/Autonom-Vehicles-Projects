...
def detect_object(frame, save_img=False):
    weights, view_img,  imgsz = 'C:/Users/ENES DORUK/Desktop/AirSim/PythonClient/car/BTUCARF/objectDetection/best.pt', 1, 640
    ...
    pred = non_max_suppression(pred, 0.5, 0.6, agnostic=True)
